...
function NpcGenerator(){
    ...
    <>
        ...
        <div className="flex-row">
            <div className="flex-column">
                <h2>Physical</h2>
                <b>Strength: </b> {makePips(RandomGenerator.getRandomAttributeWorth())}
                <b>Dexterity: </b> {makePips(RandomGenerator.getRandomAttributeWorth())}
                <b>Stamina: </b> {makePips(RandomGenerator.getRandomAttributeWorth())}
            </div>
            <div className="flex-column">
                <h2>Social</h2>
                <b>Charisma: </b> {makePips(RandomGenerator.getRandomAttributeWorth())}
                <b>Manipulation: </b> {makePips(RandomGenerator.getRandomAttributeWorth())}
                <b>Appearance: </b> {makePips(RandomGenerator.getRandomAttributeWorth())}
            </div>
            <div className="flex-column">
                <h2>Mental</h2>
                <b>Perception: </b> {makePips(RandomGenerator.getRandomAttributeWorth())}
                <b>Intelligence: </b> {makePips(RandomGenerator.getRandomAttributeWorth())}
        ...
        <div className="flex-row">
            <div className="flex-column">
                ...
                <b>Expression: </b> {makePips(RandomGenerator.getRandomAbilityWorth())}
                <b>Intimidation: </b> {makePips(RandomGenerator.getRandomAbilityWorth())}
                <b>Leadership: </b> {makePips(RandomGenerator.getRandomAbilityWorth())}
                <b>Streetwise: </b> {makePips(RandomGenerator.getRandomAbilityWorth())}
                <b>Subterfuge: </b> {makePips(RandomGenerator.getRandomAbilityWorth())}
            </div>
            <div className="flex-column">
                <h2>Skills</h2>
                ...
                <b>Martial Arts: </b> {makePips(RandomGenerator.getRandomAbilityWorth())}
                <b>Meditation: </b> {makePips(RandomGenerator.getRandomAbilityWorth())}
                ...
                <b>Technology: </b> {makePips(RandomGenerator.getRandomAbilityWorth())}
            </div>
            <div className="flex-column">
                <h2>Knowledges</h2>
                ...
                <b>Investigation: </b> {makePips(RandomGenerator.getRandomAbilityWorth())}
